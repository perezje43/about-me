...
// var questionsArray = ['Am I from Seattle?','Have I been skydiving before?',
// 'My favorite place I\'ve recently visted is DC?','My favorite burger place is In\' N\' Out?','Have I studied abroad in Tahiti?'];
//
...
//
// if(answer6 === 23){
//   console.log('The user\'s guess was: ' + answer6);
...
//
// if(ageGuesses < 5){
//   alert('Correct! You used ' + ageGuesses + ' out of your 4 guesses!');
//   totalTally++;
// }else{
...
while(guess === false && guessNumber < 6){
  for(var i = 0; i < 6; i++){
    if(answer7 === places[i]){
      console.log('The user guessed a country correctly with: ' + answer7);
  ...
  if(guess === false){
    console.log(userName + ' guessed incorrectly with: ' + answer7);
